...
public class mainGrafic extends JFrame {
	...
	public mainGrafic() {
		...
		final JComboBox netClass = new JComboBox();
		netClass.addItem("A");
		netClass.addItem("B");
		netClass.addItem("C");
		
		final JComboBox netNumber = new JComboBox();
		netNumber.addItem("1");
		netNumber.addItem("2");
		netNumber.addItem("4");
		netNumber.addItem("8");
		netNumber.addItem("16");
		netNumber.addItem("32");
		netNumber.addItem("64");
		netNumber.addItem("128");
